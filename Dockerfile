...
RUN echo "CREATE DATABASE kdGG OWNER spring;" >> /docker-entrypoint-initdb.d/init.sql
RUN echo "GRANT ALL PRIVILEGES ON DATABASE kdGG TO spring;" >> /docker-entrypoint-initdb.d/init.sql
